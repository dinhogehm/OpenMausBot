...
<ProductScreenshot name="docs-fresh-bot" alt="A new OpenMausBot bot named Bramble asking what it should help with" caption="A clean first-run bot. Each conversation belongs to a real agent process, not a simulated contact." />

<Cards>
  <Card title="Install OpenMausBot" href="/docs/getting-started/installation" description="Download a signed build or run the app from source." />
...
| Draw a pipeline my bots run on their own | [Workflows](./features/workflows.mdx) |
