// Pinned Google Antigravity ACP releases. The registry entry is MIT-licensed
// T3 Code data, independently checked against Google's published artifacts.
// Source: agentclientprotocol/registry@536e378b70a7a6d5f078a9160180e3569a23253c
...
const RELEASES = new Map<string, AntigravityReleaseAsset>([
  [
    "darwin-arm64",
    {
...
export function resolveAntigravityReleaseAsset(
  ...
  return RELEASES.get(`${platform}-${arch}`) ?? null;
}
