...
import type { Workflow, WorkflowApprovalCardData, WorkflowIssue, WorkflowRun } from "./workflow.ts";
...
export type ServerFrame =
  ...
  /** Workflow Designer (fork): a definition saved or re-validated, a run
   * transition, a definition deleted — as server/workflow-store.ts emits them. */
  | { kind: "workflow"; workflow: Workflow & { issues?: WorkflowIssue[] } }
  | { kind: "workflow-run"; run: WorkflowRun }
  | { kind: "workflow.deleted"; id: string }
